...
class Dynamixel{
 ...
 private:  
  ...
  VectorXd ref_th_dot_ = VectorXd::Zero(num_of_dynamixels);
  VectorXd ref_torque_ = VectorXd::Zero(num_of_dynamixels);
  VectorXd th_ = VectorXd::Zero(num_of_dynamixels);
  VectorXd th_last_ = VectorXd::Zero(num_of_dynamixels);
  VectorXd th_dot_ = VectorXd::Zero(num_of_dynamixels);
  VectorXd th_dot_est_ = VectorXd::Zero(num_of_dynamixels);
